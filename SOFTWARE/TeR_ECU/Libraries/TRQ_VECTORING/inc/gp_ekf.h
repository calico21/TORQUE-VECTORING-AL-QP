...
#define GP_EKF_STATE_MU_RL   2  // Rear-Left friction coefficient
#define GP_EKF_STATE_MU_RR   3  // Rear-Right friction coefficient
#define GP_EKF_NUM_STATES    4

typedef struct {
    float x[GP_EKF_NUM_STATES];                    // State vector
    float P[GP_EKF_NUM_STATES][GP_EKF_NUM_STATES]; // Error Covariance Matrix
    ...
    float R_mu;                                    // Tire friction variance
